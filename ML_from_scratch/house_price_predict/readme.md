...
- Models are compared using:
  - A tabular comparison of R² scores  
  - A bar chart visualization for easy comparison  
...
A bar chart is used to visually compare the R² scores of all three models, making performance differences easy to interpret.
